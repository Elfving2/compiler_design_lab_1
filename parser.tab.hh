...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_AMPERSAND (std::string v)
      {
        return symbol_type (token::AMPERSAND, std::move (v));
      }
#else
      static
      symbol_type
      make_AMPERSAND (const std::string& v)
      {
        return symbol_type (token::AMPERSAND, v);
      }
#endif
