  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_POWER = 12,                            // POWER
        S_FLOAT_TYPE = 13,                       // FLOAT_TYPE
        S_INT_TYPE = 14,                         // INT_TYPE
        S_VOLATILE = 15,                         // VOLATILE
        S_ID = 16,                               // ID
        S_COLON = 17,                            // COLON
        S_ASSIGN = 18,                           // ASSIGN
        S_RETURN = 19,                           // RETURN
        ...
        S_rules = 27,                            // rules
        S_math_expression = 28,                  // math_expression
        S_factor = 29,                           // factor
        S_type = 30,                             // type
        S_create_variable = 31,                  // create_variable
        S_print = 32,                            // print
        S_return = 33,                           // return
        S_block = 34,                            // block
        S_main = 35                              // main
